			...
			if(pos!=null&& pos.last_sentence_type.equals("RMC"))
			{
				...
				try
				{
					Vector v=new Vector();
				        ...
				        v.add(pos.dgps_age);
				        v.add(pos.mode);
				        v.add(pos.sat_in_use);
				        v.add(pos.fix_type);
				        v.add(pos.PDOP);
				        v.add(pos.HDOP);
				        v.add(pos.VDOP);
				        v.add(pos.local_tz);
				        v.add(pos.last_sentence_type);
					//public boolean fixed = false;

					OSCMessage msg_pos=new OSCMessage("/pos",v);
					portOut.send(msg_pos);
				}
				catch(Exception e)
				{
					System.err.println("SerialHookNMEA: "+e);
...
//GPSPosition.java from https://github.com/7890/nmea_parser
